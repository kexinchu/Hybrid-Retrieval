...
def main() -> None:
    ...
    summary = (
        df.groupby(["predicate_kind", "predicate", "strategy"])
        .agg(
        ...
        .reset_index()
        .sort_values(["predicate_kind", "predicate", "strategy"])
    )
    ...
    print(
        ...
        .head(15)[
            ["predicate_kind", "predicate", "strategy", "p95_ms", "recall", "exact_dists", "ann_returned", "selectivity"]
        ]
        .to_string(index=False)
    )
